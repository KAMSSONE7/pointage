...
def page_inscription (page: ft.Page):
    ...
    # Ajouter les styles spécifiques aux menus déroulants
    ...
    button_width = 160 if not is_mobile else 115
        ...
        content=ft.Column([
            ...
            ft.Container(
                content=ft.Column([
                    ...
                    ft.Row([revenir, valider], alignment=ft.MainAxisAlignment.CENTER),
