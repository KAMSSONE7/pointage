...
from page_stat1  import *
from page_stat2  import *
...
def main(page: ft.Page):
    ...
    def on_route_change(e):
        ...
        if page.route == "/page_connexion":
            ...
            page.views.append(ft.View(route="/page_stat1",controls=page_stat1(page),bgcolor=col))
        elif page.route=="/page_stat2":
            page.views.append(ft.View(route="/page_stat2",controls=page_stat2(page),bgcolor=col))
    ...
    # Redirection initiale vers la page de transition
